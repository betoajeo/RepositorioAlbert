      ...
      <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
        <div class="d-flex align-items-center">
          ...
          <!-- <div class="d-block">
            ...
            <a href="../../pages/examples/sign-in.php" name="sign-in" class="btn btn-secondary text-dark btn-xs"><span class="mr-2"><span class="fas fa-sign-out-alt"></span></span>Sign Out</a>
          </div> -->
        </div>
