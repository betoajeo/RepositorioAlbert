...
<meta name="title" content="Volt Bootstrap 5 Dashboard - Modals">
...
<meta property="og:title" content="Volt Bootstrap 5 Dashboard - Modals">
...
<meta property="twitter:title" content="Volt Bootstrap 5 Dashboard - Modals">
        ...
        <li class="nav-item">
          ...
          <div class="multi-level collapse  show " role="list" id="submenu-components" aria-expanded="false">
              <ul class="flex-column nav">
                  ...
                  <li class="nav-item  active "><a class="nav-link" href="../../pages/components/modals.html"><span>Modals</span></a></li>
              ...
              <a class="dropdown-item font-weight-bold" href="#"><span class="fas fa-sign-out-alt text-danger"></span>Logout</a>
                        ...
                        <div class="py-4">
                            ...
                            <div class="d-flex justify-content-between w-100 flex-wrap">
                                ...
                                <div>
                                    <a href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/components/modals/" class="btn btn-outline-gray"><i class="far fa-question-circle mr-1"></i> Modals Docs</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card border-light shadow-sm">
                                    <div class="card-body">     
                                        <div class="row d-block mt-4">
                                                                        ...
                                                                        <form action="#" class="mt-4">
                                                                            ...
                                                                            <div class="form-group mb-4">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="email" class="form-control" placeholder="example@company.com" id="exampleInputEmailCard1">
                                                                                </div>  
                                                                            </div>
                                                                            <!-- End of Form -->
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="form-group mb-4">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <input type="password" placeholder="Password" class="form-control" id="exampleInputPasswordCard1">
                                                                                    </div>  
                                                                                </div>
                                                                                <!-- End of Form -->
                                            ...
                                            <div class="col-md-4">
                                                <!-- Button Modal -->
                                                <button type="button" class="btn btn-block btn-primary mb-3" data-toggle="modal" data-target="#modal-form-signup">Sign Up</button>
                                                <!-- Modal Content -->
                                                                        ...
                                                                        <form action="#">
                                                                            ...
                                                                            <div class="form-group mb-4">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="email" class="form-control" placeholder="example@company.com" id="exampleInputEmailCard3">
                                                                                </div>  
                                                                            </div>
                                                                            <!-- End of Form -->
                                                                            <div class="form-group">
                                                                                ...
                                                                                <!-- Form -->
                                                                                <div class="form-group mb-4">
                                                                                    <label for="exampleInputPasswordCard4">Confirm Password</label>
                                                                                    <div class="input-group">
                                                                                        <span class="input-group-text" id="basic-addon5"><span class="fas fa-unlock-alt"></span></span>
                                                                                        <input type="password" placeholder="Confirm Password" class="form-control" id="exampleInputPasswordCard5">
                                                                                    </div>  
                                                                                </div>
                                                                                <!-- End of Form -->
                                            ...
                                            <div class="col-md-4">
                                                <!-- Button Modal -->
                                                <button type="button" class="btn btn-block btn-primary mb-3" data-toggle="modal" data-target="#modal-subscribe">Subscribe</button>
                                                <!-- Modal Content -->
                                                    ...
                                                    <div class="modal-dialog modal-tertiary modal-dialog-centered modal-lg" role="document">
                                                        <div class="modal-content bg-dark text-white">
                                                            ...
                                                            <div class="modal-body text-center py-3">
                                                                <span class="modal-icon display-1-lg"><span class="fas fa-envelope-open-text"></span></span>
                                                                ...
                                                                <div class="form-group px-5">
                                                                    <div class="d-sm-flex flex-column flex-sm-row mb-3 justify-content-center">
                                                                        <input type="text" id="modalInputSubscribe7" class="mr-sm-1 mb-2 mb-sm-0 form-control form-control-lg" placeholder="example@company.com">
                                                                        <button type="submit" class="ml-sm-1 btn btn-lg btn-tertiary">Subscribe</button>
                                                                    </div>
                                                                </div>
                                                            </div>
